...
type Request struct {
	Host     string `protobuf:"bytes,1,opt,name=host" json:"host,omitempty"`
	TunnelID string `protobuf:"bytes,2,opt,name=tunnelID" json:"tunnelID,omitempty"`
}
...
func (m *Request) GetTunnelID() string {
	if m != nil {
		return m.TunnelID
	}
	return ""
...
var fileDescriptor0 = []byte{
	...
	0xb1, 0x64, 0xe4, 0x17, 0x97, 0x40, 0xd5, 0x80, 0xd9, 0x4a, 0x96, 0x5c, 0xec, 0x41, 0xa9, 0x85,
	0xa5, 0xa9, 0xc5, 0x25, 0xd8, 0xa4, 0x85, 0xa4, 0xb8, 0x38, 0x4a, 0x4a, 0xf3, 0xf2, 0x52, 0x73,
	0x3c, 0x5d, 0x24, 0x98, 0xc0, 0xe2, 0x70, 0xbe, 0x51, 0x36, 0x17, 0xb3, 0x47, 0x69, 0x92, 0x90,
	0x21, 0x17, 0x7b, 0x40, 0x51, 0x6a, 0x41, 0x62, 0x51, 0xaa, 0x90, 0xb0, 0x1e, 0xcc, 0x85, 0x7a,
	0x70, 0xe7, 0x49, 0x09, 0xa2, 0x08, 0x82, 0x1d, 0x62, 0xc8, 0xc5, 0xee, 0x9c, 0x9f, 0x97, 0x97,
	0x9a, 0x5c, 0x22, 0x84, 0x29, 0x8b, 0xac, 0x01, 0xea, 0x34, 0x03, 0x46, 0x27, 0xd6, 0x28, 0xe6,
	0xc4, 0x82, 0xcc, 0x24, 0x36, 0x70, 0x48, 0x18, 0x03, 0x02, 0x00, 0x00, 0xff, 0xff, 0xf9, 0x7e,
	0xda, 0xcd, 0x16, 0x01, 0x00, 0x00,
}
